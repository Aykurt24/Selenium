...
public class _09_GoToCheckoutPageTest2 extends BaseDriver {
    public static void main(String[] args) {
        driver.get("https://www.saucedemo.com/");
        login("standard_user", "secret_sauce");
        String result = goToCheckoutPage("", "Aykurt", "1234");
        Assert.assertEquals("Error: First Name is required", result);
        driver.quit();
    }
