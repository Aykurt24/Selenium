...
public class _12_XPathPlan {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            driver.findElement(By.xpath("//*[contains(text(),'THANK YOU')]"));
            System.out.println("Thank you page success!");
        } catch (NoSuchElementException e) {
            System.out.println("Thank you page failure!");
        }
        driver.quit();
    }
}
