...
public class _09_GoToCheckoutPageTest4 extends BaseDriver {
    public static void main(String[] args) {
        driver.get("https://www.saucedemo.com/");
        login("standard_user", "secret_sauce");
        String result = goToCheckoutPage("Dogan", "Aykurt", "");
        Assert.assertEquals("Error: Postal Code is required", result);
        driver.quit();
    }
